...
exports.buildFacturePdf = buildFacturePdf;
...
async function buildFacturePdf(quote, opts) {
    ...
    const conditionsTxt = "Facture payable par virement (libellé : nom de l'organisateur, numéro de contrat), chèque ou espèces. " +
    ...
    y = yTop - 16;
    t(`Facture établie à Huisseau-sur-Cosson, le ${new Date().toLocaleDateString("fr-FR")}.`, M, y, 8, r, C.gris);
